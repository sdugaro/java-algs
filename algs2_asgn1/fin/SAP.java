 ...
 * Dependencies: algs4.jar for StdDraw.java, In.java, and StdOut.java
 *               
...
public class SAP {
     ...
     * once our constructor completes data can no longer be modified
     */
    ...
    public static void main(String[] args) {
        ...
        //StdOut.printf("Input 2 vertex integer id numbers >\n ");
        while (!StdIn.isEmpty()) {
            int v = StdIn.readInt();
            int w = StdIn.readInt();

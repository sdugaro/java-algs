...
public class KdTree {
    ...
    private void levelOrderPrint() {
        ...
        while(!q.isEmpty()) {
            ...
            StdOut.println(n.level +" : "+ n.p +" "+ orient +" "+ n.rect);
            q.enqueue(n.lb);
            q.enqueue(n.rt);
        }
    }
     ...
     * Neighbor search we should just hit each nod once.
     */
    public void draw() {
        unitSquare.draw();
     ...
     * searches dont descend far enough. 
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // KD-Tree Boundary point containment
        StdDraw.setPenRadius(0.01);
        StdDraw.setPenColor(StdDraw.YELLOW);
        RectHV rCheck = new RectHV(0.206107,0.793893,0.65,1.0);
        Point2D pCheck = new Point2D(0.5,1.0);
        rCheck.draw();
        pCheck.draw();
        StdOut.println(">>>>>>"+rCheck+" contains "+pCheck+"? "+rCheck.contains(pCheck));
        */

...
public class SeamCarver {
   ...
   public  double energy(int x, int y) {
       ...
       Color x0 = img.get(x+1).get(y);
       Color x1 = img.get(x-1).get(y);
       Color y0 = img.get(x).get(y+1);
       Color y1 = img.get(x).get(y-1);

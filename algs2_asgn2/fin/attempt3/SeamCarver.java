...
public class SeamCarver {
    ...
    private int width;
    private int height;
    //private Picture pic;   // no need to maintain pic
    ...
    //private enum TransposeState { Horizontal, Vertical; }
    //private TransposeState orient;
   ...
   public SeamCarver(Picture picture) {
       ...
       //orient = TransposeState.Vertical;
   ...
   public Picture picture() {
       ...
       // if computed horizontal seam removal, transpose back
       //if( orient == TransposeState.Horizontal ) transpose();
    ...
    * 
    * Always orient to compute seam vertically
    *  
    */
   ...
   private void transpose() {
       ...
       /*
       if (orient==TransposeState.Vertical) {
    	   orient = TransposeState.Horizontal;
    	   //System.out.println("Transposed V->H");
       } else {
    	   orient = TransposeState.Vertical;
    	   //System.out.println("Transposed H->V");	   
       }
       */
   }
    ...
    *
    * Be orientation aware, such that if we are already transposed
    * we can again run the findVerticalSeam instead of transposing
    * H-V and back again each time. This would would move around a
    * lot of data for large images and multiple consecutive calls.
    * When the client requests a picture, we transpose a transposed
    * image back so its in the correct space.  
    */
   public int[] findHorizontalSeam() {
	   //if (orient == TransposeState.Vertical) transpose();
	   transpose();
       int[] seam = findSeam();
       transpose();
       return seam;
